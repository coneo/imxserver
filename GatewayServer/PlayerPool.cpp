...
{
	m_pPlayer = new GatewayPlayer[MaxPlayerCount];
...
GatewayPlayer* PlayerPool::GetPlayer( PlayerID_t PlayerID )
{
...
GatewayPlayer* PlayerPool::NewPlayer( )
{
	int iRet = 0;
...
GatewayPlayer* PlayerPool::NewPlayer( PlayerID_t PlayerID )
{
	...
	{
		GatewayPlayer* pPlayer = &(m_pPlayer[PlayerID]);
